...
int main()
{
	...
	printf("HashMap: Check %d updated float elements in the hashmap: ",
	 num_els);
	for (i = 0; i < num_els; i++) {
		char key[KEY_LEN] = {0};
		sprintf(key, "%d", i);
	...
	printf("HashMap: Update %d updated float elements to long elements in the "
	       "hashmap: ",
	 num_els);
	for (i = 0; i < num_els; i++) {
		char key[KEY_LEN] = {0};
	...
	printf("HashMap: Update %d updated long elements to double elements in the "
	       "hashmap: ",
	 num_els);
	for (i = 0; i < num_els; i++) {
		char key[KEY_LEN] = {0};
