...
void initialize_set(SimpleSet* set, int start, int elements, int itter,
 int TEST)
{
	int i;
...
int main()
{
	...
	printf(
	 ...
	 "so that the statement x ∈ A means that x is an element of the set "
	 "A. In other words, x is one of the objects in the collection of "
	 "(possibly many) objects in the set A.\n");
	...
	printf("\n\n==== Test Set Subset ====\n");
	printf("A set A is a subset of another set B if all elements of the set A "
	       "are elements of the set B. In other words, the set A is contained "
	...
	printf(
	 "Set A is a strict subset of another set B if all elements of the "
	 "set A are elements of the set B. In other words, the set A is "
	 "contained inside the set B. A ≠ B is required. The strict subset "
	...
	printf("\n\n==== Test Set Superset ====\n");
	printf("Superset Definition: A set A is a superset of another set B if all "
	...
	printf("Strict Superset Definition: A set A is a superset of another set B "
	       "if all elements of the set B are elements of the set A. A ≠ B is "
	       "required. The superset relationship is denoted as A ⊃ B.\n");
	...
	printf("The intersection of a set A with a B is the set of elements that "
	       "are in both set A and B. The intersection is denoted as A ∩ B.\n");
	set_destroy(&A);
	set_destroy(&B);
	set_init(&A);
	set_init(&B);
	...
	printf("\n\n==== Test Set Difference ====\n");
	printf(
	 "The set difference between two sets A and B is written A ∖ B, and "
	 "means the set that consists of the elements of A which are not "
	 "elements of B: x ∈ A ∖ B ⟺ x ∈ A ∧ x ∉ B. Another frequently seen "
	 "notation for S ∖ T is S − T.\n");
	set_clear(&C);
	...
	printf("The symmetric difference of two sets A and B is the set of "
	       "elements either in A or in B but not in both. Symmetric difference "
	       "is denoted A △ B or A * B.\n");
	set_clear(&C);
	...
	/*  Test Set Union: C = A ∪ B denotes that all elements from A and B are
	    part of C */
	printf("\n\n==== Test Set Union ====\n");
	printf("The union of a set A with a B is the set of elements that are in "
	       "either set A or B. The union is denoted as A ∪ B.\n");
	set_clear(&C);
	set_union(&C, &A, &B);
	assert(C.used_nodes == elements * 2);
