...
/* Private Functions */
static void __add_city_as_vertex(graph_t g, char* name, double latitude,
 double longitude); /* we get to always make N and W.*/
...
/* PRIVATE FUNCTIONS */
static void
__add_city_as_vertex(graph_t g, char* name, double latitude, double longitude)
{
